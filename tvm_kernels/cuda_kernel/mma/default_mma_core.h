...
template <
    ...
    /// Cache operation of operand B
    cutlass::arch::CacheOperation::Kind CacheOpB>
struct DefaultMmaCoreVerify<Shape_, WarpShape_, InstructionShape_, ElementA_,
  ...
  using MmaTensorOp = typename cutlass::gemm::warp::DefaultMmaTensorOpVerify<
