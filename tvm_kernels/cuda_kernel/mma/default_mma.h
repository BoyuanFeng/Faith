...
template <
    ...
    bool GatherB
    >
struct DefaultMmaVerify<ElementA, LayoutA, kAlignmentA, ElementB, LayoutB,
  ...
  using MmaCore = typename cutlass::gemm::threadblock::DefaultMmaCoreVerify<
  ...
  using ThreadblockMma = cutlass::gemm::threadblock::MmaMultistageVerify<
