...
class Logger():
    def __init__(self, sess, args, summary_names, key_output_index):
        ...
        # self.train_writer = tensorflow.summary.create_file_writer(os.path.join(self.log_dir, "train"))
        # self.valid_writer = tensorflow.summary.create_file_writer(os.path.join(self.log_dir, "valid"))
        # self.test_writer = tensorflow.summary.create_file_writer(os.path.join(self.log_dir, "test"))
